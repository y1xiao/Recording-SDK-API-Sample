//
//  publisher_localuser_observer.hpp
//  recording sdk
//
//  Created by HN on 2023/8/14.
//

#ifndef publisher_localuser_observer_hpp
#define publisher_localuser_observer_hpp
...
class PublisherLocalUserObserver : public agora::rtc::ILocalUserObserver {
 public:
  PublisherLocalUserObserver(agora::rtc::IRtcConnection* connection);
  PublisherLocalUserObserver(agora::rtc::ILocalUser* user);
  virtual ~PublisherLocalUserObserver();
...
#endif /* publisher_localuser_observer_hpp */
